// Default (fallback) copy for the footer legal pages, written in Markdown.
// The live copy is managed in Admin > Pages: a *published* Page record whose
// slug matches (e.g. "privacy") overrides the default below. These defaults
// keep the pages working even if no Page record exists yet.

export const LEGAL_DEFAULTS = {
  privacy: {
    title: 'Privacy Policy',
    updated: 'September 2026',
    body: `This Privacy Policy ("Policy") applies to the personal information collected by Next Consulting LLC ("we" or "us") through the accidentcompensationhelper.com website ("Website"). We are committed to protecting your privacy and handling your personal information in accordance with applicable data protection laws.
...
### Voice Input and Audio Recordings

If you choose to use the voice input feature during our intake process, your spoken response may be recorded as an audio file, transcribed to text using a third-party speech recognition service (OpenAI Whisper), and stored alongside your intake session data. Audio recordings and transcripts are used solely to process your inquiry and match you with an attorney. You may type your answer instead of speaking at any time. By using voice input, you consent to this recording and transcription.
...
- To connect you with attorneys and to provide you with information about our services and other relevant information.
...
[help@accidentcompensationhelper.com](mailto:help@accidentcompensationhelper.com)
`,
  },
