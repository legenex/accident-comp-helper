    ...
    <AdminLayout title="Pages" breadcrumbs={[{ label: "Admin", href: "/admin" }, { label: "Pages" }]}>
      ...
      <Card className="overflow-x-auto p-0">
        {loading ? (
          ...
          <div className="p-5"><EmptyState icon={FileText} title="No pages yet" body="Create your first page." action={<AdminButton onClick={() => setEditing({ ...blank })}><Plus className="h-4 w-4" /> New Page</AdminButton>} /></div>
        ) : (
      ...
      <Modal open={!!editing} onClose={() => setEditing(null)} title={editing?.id ? "Edit Page" : "New Page"} wide>
        {editing && (
      ...
      <Modal open={!!deleteConfirm} onClose={() => setDeleteConfirm(null)} title="Delete page?">
