    ...
    <ContentCrudPage
      ...
      renderForm={(editing, setEditing) => (
        <div className="space-y-4">
          ...
          <p className="text-xs text-slate-500">Body supports Markdown (## Heading, ### Subheading, - bullet, [link](url)). Footer legal pages use slugs: privacy, terms, privacy-choices, disclosures (on disclosures, each "### State" becomes its own card). Only published pages go live.</p>
